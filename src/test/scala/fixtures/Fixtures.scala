...
object Fixtures {
  ...
  val lapB2 = Lap(5057852, pilotB, 2, 39990, 80.5)
  val lapB3 = Lap(5097842, pilotB, 3, 70323, 30.7)
  val lapB4 = Lap(5168165, pilotB, 4, 52800, 56.4)

  val lapC1 = Lap(5000000, pilotC, 1, 40000, 40.5)
  val lapC2 = Lap(5040000, pilotC, 2, 50000, 50.5)
  val lapC3 = Lap(5090000, pilotC, 3, 50000, 50.5)
